...
{{< figure src="img/drake-meme.webp" caption="Virtualizing VS. Running on bare metal" >}}
...
{{< figure src = "img/network-server.webp" caption = "My OPNsense Box" >}}
...
{{< figure src = "img/storage-server.webp" caption = "My TrueNAS Appliance and its emotional support foam roller" >}}
...
{{< figure src = "img/backup-server.webp" caption = "My 2U backup server" >}}
...
{{< figure src = "img/virtualization-server.webp" caption = "My Virtualization Server" >}}
...
{{< figure src="img/kubernetes-certifications.webp" caption="Kubernetes Certified Nerd" >}}
...
{{< figure src = "img/management-cluster.webp" caption = "3x Pi4 with 2Gb RAM" >}}
...
{{< figure src = "img/main-cluster-workers.webp" caption = "A couple Odroid boards and a Pi4 4Gb dedicated to running workloads" >}}
...
{{< figure src = "img/main-cluster-storage.webp" caption = "A couple of Odroid HC1 boards for Longhorn" >}}
...
{{< figure src="img/infrastructure-as-code-tools.webp" caption="Infrastructure-as-Code Tools" >}}
...
{{< figure src="img/monitoring-tools.webp" caption="Monitoring Tools" >}}
